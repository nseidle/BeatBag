/*
  ...
  7/30/16 - Converting to SAMD21 Mini. Pulling in barryh's filter: https://github.com/barryhannigan/SpeedBagChallenge

  12/2/16 - Milled enclosure: https://cad.onshape.com/documents/b296a359e264985023b853b6/w/9eb5ce54572ff50af782cbe7/e/9ed5980190f87b54f97fe0e4

  1/31/17 - Changed the way the display powered down.
...
//long TIME_TO_DISPLAY_OFF = 10L * 1000L; //For testing
...
void setup()
{
  ...
  SerialUSB.println("Speed Bag Counter");
...
void loop()
{
  ...
  if (detData->maxZFound > 0)
  {
    ...
    //SerialUSB.print("Hit: ");
    //SerialUSB.println(hitCounter);
    
    lastHitTime = millis(); //Record when we got this hit

    if (displayOn == false)
    {
      initDisplay(); //Bring it back on
    }
